...
class ReleaseV0170Tests(unittest.TestCase):
    ...
    def test_release_asset_builder_supports_test_channel(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            asset.write_bytes(b'xynigo-v0.17.24-test-package')
            ...
            self.assertEqual(payload['version'], '0.17.24')
    ...
    def test_web_bundle_contains_module_three_and_template(self):
        ...
        self.assertIn('Xynigo Sourcing v0.17.24', html)
        self.assertIn('累计修复测试 v0.17.24', html)
        self.assertIn("headers.set('X-Xynigo-Client-Version', '0.17.24-cloud-web')", html)
