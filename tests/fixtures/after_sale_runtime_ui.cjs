...
ctx=vm.createContext({AS_STATE:state,AS_TYPES:[], $:node, document:{
 ...
 cloudFormalExecutor:async()=>{hook();return {id:'executor',capabilities:capability?['after.sale.runtime-controls.v1','after.sale.reliable-results.v1','after.sale.receipt-recovery.v1']:[]};},
