...
class AfterSaleClaimResult(Base):
    ...
    delivered_at: Mapped[str | None] = mapped_column(String(32))
    goods_img: Mapped[str | None] = mapped_column(String(300))
    goods_images: Mapped[list] = mapped_column(JSON, nullable=False, default=list, server_default="[]")
    goods_items: Mapped[list] = mapped_column(JSON, nullable=False, default=list, server_default="[]")
    item_count: Mapped[int | None] = mapped_column(Integer)
    duration_seconds: Mapped[int | None] = mapped_column(Integer)
    submitted_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    operation_completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
