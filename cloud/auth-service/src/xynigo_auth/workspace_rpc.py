...
GET_PERMISSIONS = {
    ...
    "/api/envbatch/preferences": "resource.environment.create",
    ...
    "/api/update/status": "operations.access",
...
POST_PERMISSIONS = {
    ...
    "/api/update/check": "operations.access",
    "/api/update/prompt": "operations.access",
    "/api/lark/config": "system.lark_connection.manage",
